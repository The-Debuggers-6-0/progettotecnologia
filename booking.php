...
$bookingJs = '<script>'
    ...
    .     'd.innerHTML="<h6 class=\"mb-3\" style=\"font-size:1.3rem;font-weight:700\">Partecipante "+(ex+1)+"</h6>'
    .       '<div class=\"row\">'
    .       '<div class=\"col-md-6 mb-2\"><label class=\"form-label\" style=\"font-size:1.15rem\">Nome *<\/label>'
    .         '<input type=\"text\" name=\"pname["+ex+"]\" class=\"form-control\" style=\"font-size:1.1rem\" required><\/div>'
    .       '<div class=\"col-md-6 mb-2\"><label class=\"form-label\" style=\"font-size:1.15rem\">Cognome *<\/label>'
    .         '<input type=\"text\" name=\"psurname["+ex+"]\" class=\"form-control\" style=\"font-size:1.1rem\" required><\/div>'
    .       '<\/div>";'
    .     'c.appendChild(d);ex++;'
    .   '}'
